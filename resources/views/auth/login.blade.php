        ...
        <div class="h-full flex flex-col px-12 md:px-44 py-10 relative z-10 overflow-hidden">
            ...
            <div class="max-w-lg w-full mt-auto mb-auto bg-transparent relative z-10">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 font-medium text-lg leading-relaxed">Sign in to continue making an impact.</p>
                </div>

                <form id="loginForm" class="space-y-6">
                    <!-- Error Message -->
                    <div id="loginError" class="hidden bg-red-50 text-red-500 p-5 rounded-xl text-sm border border-red-100 italic">
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2 ml-1">
                            ...
                            <a href="#" class="text-[9px] font-bold text-[#064e3b] hover:underline uppercase tracking-tight">Forgot Password?</a>
                        </div>
                    ...
                    <div class="pt-4">
                        ...
                        <div class="text-center mt-6">
                            <p class="text-gray-500 font-medium text-[10px]">
                                New to Donify?
                                <a href="{{ route('register') }}" class="text-[#064e3b] font-bold hover:underline ml-1 uppercase">Create Account</a>
                            </p>
                        </div>
                    </div>
                </form>
