    ...
    <div class="flex flex-col md:flex-row h-screen bg-[#fbf8f6] font-quicksand overflow-hidden relative">
        ...
        <div class="w-full md:w-2/5 flex flex-col relative z-20 overflow-hidden">
            ...
            <div class="h-full flex flex-col px-8 md:px-16 py-10 relative z-10 overflow-hidden">
                ...
                <div class="mb-10   ">
                    <a href="{{ route('home') }}"
                        class="inline-flex items-center text-[#1A1A1A] hover:text-[#159774] transition-all group">
                ...
                <div class="max-w-lg w-full mt-auto mb-auto bg-transparent relative z-10">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-[#185633] font-medium text-lg leading-relaxed">Start your journey of giving and
                            impact today.</p>
                    </div>
                    ...
                    <form id="registerForm" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <div>
                                <label
                                    class="block text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a]mb-2 ml-1">First
                                    Name</label>
                            ...
                            <div>
                                <label
                                    class="block text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a]mb-2 ml-1">Last
                                    Name</label>
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a]mb-2 ml-1">Email
                                Address</label>
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <div>
                                <label
                                    class="block text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a]mb-2 ml-1">Password</label>
                            ...
                            <div>
                                <label
                                    class="block text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a]mb-2 ml-1">Role</label>
                                <div class="relative">
                                    <select id="role"
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a]mb-2 ml-1">Profile
                                Photo</label>
                            <div
                                class="flex items-center space-x-6 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                                <div id="imagePreview"
                        ...
                        <div class="pt-4">
                            ...
                            <div class="text-center mt-6">
                                <p class="text-gray-500 font-medium text-[10px]">
                                    ...
                                    <a href="{{ route('login') }}"
                                        class="text-[#064e3b] font-bold hover:underline ml-1 uppercase">Sign in</a>
                                </p>
                            </div>
                        </div>
                    </form>
        ...
        <div class="hidden md:block w-3/5 relative bg-transparent overflow-hidden">
            ...
            <div class="absolute inset-0 z-10 pointer-events-none p-12">
                ...
                <div class="absolute top-1/4 left-10 text-left max-w-[350px] opacity-90">
                    <h3 class="text-3xl font-black text-[#DAA520] leading-tight italic mb-2">"Happiness comes from your own
                        actions."</h3>
            ...
            <div class="absolute top-[40%] right-[15%] text-right max-w-[300px] opacity-100">
                <h3 class="text-4xl font-black text-[#DAA520] leading-tight italic mb-2">"Happiness doesn’t result from
                    what we get, but from what we give."</h3>
