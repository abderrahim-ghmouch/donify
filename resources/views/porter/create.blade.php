...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const initial = document.getElementById('dropInitial');
    ...
    document.getElementById('createCampaignForm').addEventListener('submit', async (e) => {
        ...
        const success = document.getElementById('launchSuccess');
        ...
        try {
            ...
            alert(err.message || 'Mission launch failed. Please verify required data.');
            btn.disabled = false;
            btn.innerHTML = 'Verify & Launch Mission';
        }
    });
});
</script>
